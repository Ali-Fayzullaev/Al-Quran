...
export const translations = {
  ru: {
    ...
    mushafModeDescription: "Читайте Коран по страницам, как в традиционном мусхафе с отображением страниц точно как в печатной версии",
    surahReading: "Чтение сур",
    surahModeDescription: "Читайте по сурам с переводами, аудио и дополнительной информацией для глубокого понимания",
    ...
    allModesSupport: "Все режимы поддерживают настраиваемые шрифты, цвета и размеры",
    switchBetweenModes: "Вы можете легко переключаться между режимами в любое время",
    ...
    motivationDescription: "Откройте для себя духовную пользу и награды чтения Священного Корана",

    // Surahs Page
    surahsOfHolyQuran: "Суры Священного Корана",
    studyAll114Chapters: "Изучайте все 114 глав Корана с переводами, аудио и инструментами для изучения",
  ...
  en: {
    ...
    mushafModeDescription: "Read the Quran page by page as in traditional mushaf with page display exactly as in the printed version",
    surahReading: "Surah Reading",
    surahModeDescription: "Read by surahs with translations, audio and additional information for deep understanding",
    ...
    motivationDescription: "Discover the spiritual benefits and rewards of reading the Holy Quran",

    // Surahs Page
    surahsOfHolyQuran: "Surahs of the Holy Quran",
    studyAll114Chapters: "Study all 114 chapters of the Quran with translations, audio and learning tools",
  ...
  uz: {
    ...
    mushafModeDescription: "Qur'onni an'anaviy mushaf kabi sahifa-sahifa o'qing, sahifalar bosma versiyasidagi kabi ko'rsatiladi",
    surahReading: "Suralar o'qish",
    surahModeDescription: "Suralar bo'yicha tarjimalar, audio va chuqur tushunish uchun qo'shimcha ma'lumotlar bilan o'qing",
    ...
    allModesSupport: "Barcha rejimlar sozlanadigan shriftlar, ranglar va o'lchamlarni qo'llab-quvvatlaydi",
    switchBetweenModes: "Istalgan vaqtda rejimlar orasida osongina o'tishingiz mumkin",
    ...
    motivationDescription: "Muqaddas Qur'onni o'qishning ruhiy foydasi va mukofotlarini kashf eting",

    // Surahs Page
    surahsOfHolyQuran: "Muqaddas Qur'on suralari",
    studyAll114Chapters: "Qur'onning barcha 114 surasini tarjimalar, audio va o'rganish vositalari bilan o'rganing",
    ...
    tryChangingSearch: "Qidiruv yoki filtr mezonlarini o'zgartirishga harakat qiling",
  ...
  уз: {
    ...
    mushafModeDescription: "Қуръонни анъанавий мусҳаф каби саҳифа-саҳифа ўқинг, саҳифалар босма версиясидагидек кўрсатилади",
    surahReading: "Суралар ўқиш",
    surahModeDescription: "Суралар бўйича таржималар, аудио ва чуқур тушуниш учун қўшимча маълумотлар билан ўқинг",
    ...
    allModesSupport: "Барча режимлар созланадиган шрифтлар, ранглар ва ўлчамларни қўллаб-қувватлайди",
    switchBetweenModes: "Истаган вақтда режимлар орасида осонгина ўтишингиз мумкин",
    ...
    motivationDescription: "Муқаддас Қуръонни ўқишнинг руҳий фойдаси ва мукофотларини кашф етинг",

    // Surahs Page
    surahsOfHolyQuran: "Муқаддас Қуръон сураларн",
    studyAll114Chapters: "Қуръоннинг барча 114 сурасини таржималар, аудио ва ўрганиш воситалари билан ўрганинг",
