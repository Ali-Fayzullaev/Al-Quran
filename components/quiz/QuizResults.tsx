...
import type { QuizResult, PerformanceLevel, IslamicMotivation } from '@/lib/quizTypes';
    ...
    >
      ...
      >
        ...
        <div className="p-6 rounded-lg bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950 dark:to-red-950 border border-orange-200 dark:border-orange-800">
          ...
          <div className="text-3xl font-bold">
            <CountUp end={(correctAnswers / answers.length) * 100} duration={2} decimals={0} />%
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-3">
          {Object.entries(performance.byType).map(([type, stats]) => {
            ...
            const typeKey = type === 'guess-surah' ? 'guessSurah' :
                          type === 'continue-ayah' ? 'continueAyah' :
                          type === 'fill-missing-word' ? 'fillMissingWord' :
                          type === 'surah-description' ? 'surahDescription' : type;
            return (
