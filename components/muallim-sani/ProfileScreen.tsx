        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                    Включить звуки и аудио-произношение
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input 
                    ...
                    checked={editedProfile.settings.audioEnabled}
                    onChange={(e) => setEditedProfile({
                      ...editedProfile,
                      settings: { ...editedProfile.settings, audioEnabled: e.target.checked }
                    })}
                  />
              ...
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input 
                    type="checkbox" 
                    className="sr-only peer" 
                    checked={editedProfile.settings.animations}
                    onChange={(e) => setEditedProfile({
                      ...editedProfile,
                      settings: { ...editedProfile.settings, animations: e.target.checked }
                    })}
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                </label>
              ...
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input 
                    type="checkbox" 
                    className="sr-only peer" 
                    checked={editedProfile.settings.vibrationEnabled}
                    onChange={(e) => setEditedProfile({
                      ...editedProfile,
                      settings: { ...editedProfile.settings, vibrationEnabled: e.target.checked }
                    })}
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                </label>
                  ...
                  {['easy', 'medium', 'hard'].map((difficulty) => (
                    <button
                      ...
                      className={`py-2 px-4 rounded-lg text-sm font-medium transition-all ${
                        editedProfile.settings.difficulty === difficulty 
                          ? 'shadow-lg transform scale-105' 
                          : 'hover:opacity-70'
                      }`}
                      style={{ 
                        backgroundColor: editedProfile.settings.difficulty === difficulty 
                          ? 'var(--color-primary)' 
                          : 'var(--color-background)',
                        color: editedProfile.settings.difficulty === difficulty 
                          ? 'white' 
                          : 'var(--color-text)',
                        borderColor: 'var(--color-border)',
                        borderWidth: '1px'
            ...
            {isEditing && (
              <button
                onClick={handleSaveProfile}
                className="mt-6 px-6 py-2 rounded-lg font-semibold hover:opacity-90 transition-opacity"
                style={{ backgroundColor: '#10B981', color: 'white' }}
              >
                ✅ Сохранить настройки
              </button>
